...
CREATE TABLE `TeamFormations` (
    ...
    `locationID` int NOT NULL,
    `sessionType` enum('Game', 'Training') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
    `sessionDate` date NOT NULL,
    `sessionTime` time NOT NULL,
    `sessionAddress` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
    `teamID` int NOT NULL,
...
CREATE TABLE `EmailLogs` (
    ...
    `bodyPreview` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
    PRIMARY KEY (`emailID`),
