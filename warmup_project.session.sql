...
INSERT INTO Locations (type, name, address, city, province, postalCode, phoneNumber, webAddress, maxCapacity) VALUES 
    ('Head', 'Pallet Club', '1 Oak St', 'Pallet Town', 'Kanto', 'K1N 7D4', '555-1234', 'http://palletvolleyball.com', 100),
...
INSERT INTO Personnel (firstName, lastName, dateOfBirth, socialSecurityNumber, medicareCardNumber, telephoneNumber, address, city, province, postalCode, email, role, mandate) VALUES 
    ('Ash', 'Ketchum', '1987-05-22', 'SSN001', 'MED001', '555-1111', '123 Pikachu Rd', 'Pallet Town', 'Kanto', 'K1N 7D4', 'ash@mvc.com', 'Coach', 'Salaried'),
...
INSERT INTO FamilyMembers (firstName, lastName, dateOfBirth, socialSecurityNumber, medicareCardNumber, telephoneNumber, address, city, province, postalCode, email) VALUES 
    ('Delia', 'Ketchum', '1960-05-15', 'FSSN001', 'FMED001', '555-1212', '123 Pikachu Rd', 'Pallet Town', 'Kanto', 'K1N 7D4', 'delia@mvc.com'),
...
INSERT INTO ClubMembers (firstName, lastName, dateOfBirth, height, weight, socialSecurityNumber, medicareCardNumber, telephoneNumber, address, city, province, postalCode, locationID, isMinor) VALUES 
    ('Pikachu', 'Electric', '2015-08-10', 0.4, 6.0, 'CSSN001', 'CMED001', '555-3001', '123 Pikachu Rd', 'Pallet Town', 'Kanto', 'K1N 7D4', 1, TRUE),
